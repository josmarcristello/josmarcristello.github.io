...
function cheat(){
    ...
    Swal.fire({
        ...
        if (!result.value){
            ...
            document.querySelector("h1").innerHTML='<h1>The Great <span class="block font-semibold text-5xl leading-10">RGB(100, 100, 100)</span> <span style="rgb(197,48,48)">Cheating</span> Game</h1>'
